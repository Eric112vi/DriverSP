        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">YGP Medan Invoices</h4>
                    <p class="card-title-desc">
                    </p>

                    <table id="table-ygp" class="table table-bordered table-hover nowrap w-100">
...
@section('script')
    <script>
        $(document).ready(function () {
            ...
            $('#table-ygp tbody').on('click', 'tr', function () {
                var id = $(this).data('id');
                if (id) {
                   $.ajax({
