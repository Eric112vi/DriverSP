        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">Mitsuboshi Invoices</h4>
                    <p class="card-title-desc">
                    </p>

                    <table id="table-mitsu" class="table table-bordered table-hover nowrap w-100">
...
<?php $__env->startSection('script'); ?>
    <script>
        $(document).ready(function () {
            ...
            var table = $('#table-mitsu').DataTable({
                pageLength: 50,
                bAutoWidth: false,
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\CS-App\resources\views/universal/mitsu-medan.blade.php ENDPATH**/ ?>