        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">Philips Invoices</h4>
                    <p class="card-title-desc">
                    </p>

                    <table id="table-philips" class="table table-bordered table-hover nowrap w-100">
...
<?php $__env->startSection('script'); ?>
    <script>
        $(document).ready(function () {
            ...
            var table = $('#table-philips').DataTable({
                pageLength: 50,
                bAutoWidth: false,
            ...
            $(document).on('click', '.photo-thumb', function(e){
                ...
                $('#imgModal').modal('show');
                        ...
                        $('#table-philips tbody').on('click', 'tr', function () {
                var id = $(this).data('id');
                if (id) {
                   $.ajax({
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\CS-App\resources\views/universal/philips-medan.blade.php ENDPATH**/ ?>