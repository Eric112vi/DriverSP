        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">Universal Invoices</h4>
                    <p class="card-title-desc">
                    </p>

                    <table id="table-universal" class="table table-bordered table-hover nowrap w-100">
...
<?php $__env->startSection('script'); ?>
    <script>
        $(document).ready(function () {
            ...
            var table = $('#table-universal').DataTable({
                pageLength: 50,
                bAutoWidth: false,
                ...
                scrollX: true,  
                ajax: {
                    url: "<?php echo e(route('universal')); ?>"
                },
                columns: [
                    {
                        data: 'DT_RowIndex',
            ...
            $('#table-universal tbody').on('click', 'tr', function () {
                var id = $(this).data('id');
                if (id) {
                   $.ajax({
                        url: "<?php echo e(route('invoice.detail')); ?>",
                        method: 'GET',
                        data: { id: id },
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\CS-App\resources\views/universal/universal-other-branch.blade.php ENDPATH**/ ?>