            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    <img class="rounded-circle header-profile-user" src="<?php echo e(isset(Auth::user()->avatar) ? asset(Auth::user()->avatar) : asset('build/images/users/avatar-1.jpg')); ?>"
                        alt="Header Avatar">
                    <span class="d-none d-xl-inline-block ms-1" key="t-henry"><?php echo e(Auth::user() ? ucfirst(Auth::user()->name) : ''); ?></span>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" id="change-password">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" value="<?php echo e(Auth::user() ? Auth::user()->id : ''); ?>" id="data_id">
                    <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>" name="password"
                    ...
                    <div class="mt-3 d-grid">
                        <button class="btn btn-primary waves-effect waves-light UpdatePassword" data-id="<?php echo e(Auth::user() ? Auth::user()->id  : ''); ?>"
...
<?php /**PATH C:\laragon\www\CS-App\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>