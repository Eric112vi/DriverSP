        ...
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addForm" name="addForm" class="form-horizontal" action="<?php echo e(route('addstaff')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <?php $__currentLoopData = $cabang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="form-check form-switch ms-2 mb-3">
                                <input class="form-check-input" type="checkbox" id="permission<?php echo e($permission->id); ?>" name="permission<?php echo e($permission->id); ?>" value="<?php echo e($permission->id); ?>" autocomplete="off">
                                <label class="form-check-label" for="permission<?php echo e($permission->id); ?>">
                                    <?php echo e(implode(' ', array_map('strtoupper', explode('_', str_replace('cabang_', '', $permission->name))))); ?>
                        ...
                        <?php if($others->isNotEmpty()): ?>
                            ...
                            <?php $__currentLoopData = $others; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="form-check form-switch ms-2 mb-3">
                                    <input class="form-check-input" type="checkbox" id="permission<?php echo e($permission->id); ?>" name="permission<?php echo e($permission->id); ?>" value="<?php echo e($permission->id); ?>" autocomplete="off">
                                    <label class="form-check-label" for="permission<?php echo e($permission->id); ?>">
                                        <?php echo e(ucwords(str_replace('_', ' ', \Illuminate\Support\Str::plural($permission->name)))); ?>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editForm" name="editForm" class="form-horizontal" action="<?php echo e(route('updatestaff')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <?php $__currentLoopData = $cabang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="form-check form-switch mb-3">
                                <input class="form-check-input" type="checkbox" id="permission_edit<?php echo e($permission->id); ?>" name="permission_edit<?php echo e($permission->id); ?>" value="<?php echo e($permission->id); ?>" autocomplete="off">
                                <label class="form-check-label" for="permission_edit<?php echo e($permission->id); ?>">
                                    <?php echo e(implode(' ', array_map('strtoupper', explode('_', str_replace('cabang_', '', $permission->name))))); ?>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#table-user").on("click", ".editStaff", function () { 
                ...
                // AJAX request
                $.ajax({
                    url: '<?php echo e(route("editstaff")); ?>',
                    type: 'GET',
                    data: {
                        user_id: user_id
                    },
            ...
            $('#btn-update').on('click', function (e) {
                ...
                // AJAX request
                $.ajax({
                    url: '<?php echo e(route("updatestaff")); ?>',
                    type: 'POST',
                    data: data,
                    dataType: "json",
                    success: function (data) {
            ...
            function resetPassword(user_id) {
                // AJAX request
                $.ajax({
                    url: '<?php echo e(route("resetpassstaff")); ?>',
                    type: 'POST',
                    data: {
                        user_id: user_id
                    },
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\CS-App\resources\views/auth/user.blade.php ENDPATH**/ ?>