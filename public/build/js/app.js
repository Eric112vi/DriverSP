...
(function ($) {
    ...
    function initLeftMenuCollapse() {
        $('#vertical-menu-btn').on('click', function (event) {
            ...
            // After sidebar toggle, trigger a resize and adjust DataTables columns so tables expand/contract
            // Use a small delay to allow CSS/layout transition to complete
            setTimeout(function () {
                try {
                    if (window.jQuery && jQuery.fn && jQuery.fn.dataTable) {
                        // Adjust all visible DataTable instances
                        jQuery.fn.dataTable.tables({visible: true, api: true}).columns.adjust();
                    } else {
                        // Fallback: dispatch a resize event
